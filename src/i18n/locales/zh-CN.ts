...
const zhCN: TranslationDict = {
  ...
  toolbox: {
    ...
    footerDescription: '技能、专家、MCP 统一管理',
    // Skills Section
    ...
    createManually: '手动创建',
    nameFormatHint: '不能以连字符开头或结尾，不允许包含空格',
    ...
    uninstallConfirmMessage: '专家将被移到回收站（~/.abu/agents/.trash/），可手动恢复。确定要卸载吗？',
    installed: '已安装',
    ...
    agentAvatar: '头像',
    agentAvatarUpload: '上传头像',
    agentAvatarUploadHint: '支持 JPG、PNG、WebP、GIF，最大 2MB',
    agentAvatarUploadInvalid: '请选择 2MB 以内的图片文件',
    agentAvatarDefaultPresets: '默认头像',
  ...
  agentAvatarPresetLabels: {
    'preset:abu': '阿布默认',
    'preset:engineer': '开发工程师',
    'preset:product': '产品经理',
    'preset:data': '数据分析师',
    'preset:writer': '内容编辑',
    'preset:business': '业务顾问',
  },
  ...
  guide: {
    ...
    step3Title: '使用工具与技能',
    step3Desc: '在工具箱中启用技能、子专家、MCP 服务',
    step4Title: '探索设置',
